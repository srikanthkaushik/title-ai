...
public class FeeScheduleTools {
    ...
    public List<Map<String, Object>> lookup_fees(
            @McpToolParam(description = "Transfer type: PURCHASE or RELOCATION") String transferType,
            @McpToolParam(description = "Registration county in Marion (e.g., Marion County, Dunmore County)") String county) {
    ...
    public Map<String, Object> lookup_fee_by_code(
            @McpToolParam(description = "Fee code, e.g., TITLE_TRANSFER, VIN_INSPECTION, EMISSIONS") String feeCode) {
